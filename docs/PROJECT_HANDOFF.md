...
Last verified: **2026-08-28 IST**. Run commands from:
...
- GitHub desktop distribution is implemented for the v0.3.0 scalable preview. CI passes the 116-test
  ...
  archives/signatures and a six-platform `latest.json`; its draft-only asset
  audit is green. The downloaded Apple Silicon updater bundle also passed
