      ...
      <aside className="relative flex h-full w-full max-w-[520px] flex-col border-l border-[#dfe5eb] bg-white shadow-[-20px_0_60px_rgba(11,23,41,.18)]">
        ...
        <div className="flex-1 overflow-y-auto p-6">
          ...
          {source.repeal_label === "no_longer_in_force" ? (
            <div className="mt-3 flex items-start gap-3 rounded-xl border border-[#f0b8ad] bg-[#fff1ed] p-4">
              <CircleAlert size={17} className="mt-0.5 shrink-0 text-[#b7411f]" />
              <div>
            ...
            <div className="mt-3 flex items-start gap-3 rounded-xl border border-[#f0d8ad] bg-[#fff8eb] p-4">
              ...
              <div>
                  ...
                  <ul className="mt-2 space-y-1">
                    {source.section_mappings.map(mapping => (
                      <li
                        ...
                        className="text-xs leading-5 text-[#54515d]"
                      >
                        ...
                        {mapping.subject ? (
                          <span className="text-[#827b8c]"> — {mapping.subject}</span>
                        ) : null}
                        {mapping.ingredients_changed ? (
                          <span className="ml-1 rounded bg-[#fdeadf] px-1.5 py-0.5 text-[10px] font-semibold text-[#b7411f]">
                            elements changed
                          </span>
                        ) : null}
                        {mapping.note ? (
                          <span className="mt-0.5 block text-[11px] leading-4 text-[#948da0]">
                            {mapping.note}
                          </span>
                        ) : null}
                      </li>
                ...
                {source.unmapped_repealed_provisions?.length ? (
                  <p className="mt-2 text-[11px] leading-4 text-[#948da0]">
